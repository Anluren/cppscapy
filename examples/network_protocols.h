...
public:
    ...
    // qr field (1 bits)
    uint8_t qr() const {
        return BitField<uint8_t>(const_cast<std::vector<uint8_t>&>(data_), 16, 1).get();
    }
    void set_qr(uint8_t value) {
        BitField<uint8_t>(data_, 16, 1).set(value);
    }
    
    // opcode field (4 bits)
    uint8_t opcode() const {
        return BitField<uint8_t>(const_cast<std::vector<uint8_t>&>(data_), 17, 4).get();
    }
    void set_opcode(uint8_t value) {
        BitField<uint8_t>(data_, 17, 4).set(value);
    }
    ...
    // ra field (1 bits)
    uint8_t ra() const {
        return BitField<uint8_t>(const_cast<std::vector<uint8_t>&>(data_), 24, 1).get();
    }
    void set_ra(uint8_t value) {
        BitField<uint8_t>(data_, 24, 1).set(value);
    }
    
    // z field (3 bits)
    uint8_t z() const {
        return BitField<uint8_t>(const_cast<std::vector<uint8_t>&>(data_), 25, 3).get();
    }
    void set_z(uint8_t value) {
        BitField<uint8_t>(data_, 25, 3).set(value);
    }
    
    // rcode field (4 bits)
    uint8_t rcode() const {
        return BitField<uint8_t>(const_cast<std::vector<uint8_t>&>(data_), 28, 4).get();
    }
    void set_rcode(uint8_t value) {
        BitField<uint8_t>(data_, 28, 4).set(value);
    }
    ...
    void set_qdcount(uint16_t value) {
        BitField<uint16_t>(data_, 32, 16).set(value);
    }
    
    // ancount field (16 bits)
    uint16_t ancount() const {
        return BitField<uint16_t>(const_cast<std::vector<uint8_t>&>(data_), 48, 16).get();
    }
    void set_ancount(uint16_t value) {
        BitField<uint16_t>(data_, 48, 16).set(value);
    }
    
    // nscount field (16 bits)
    uint16_t nscount() const {
        return BitField<uint16_t>(const_cast<std::vector<uint8_t>&>(data_), 64, 16).get();
    }
    void set_nscount(uint16_t value) {
        BitField<uint16_t>(data_, 64, 16).set(value);
    }
    
    // arcount field (16 bits)
    uint16_t arcount() const {
        return BitField<uint16_t>(const_cast<std::vector<uint8_t>&>(data_), 80, 16).get();
    }
    void set_arcount(uint16_t value) {
        BitField<uint16_t>(data_, 80, 16).set(value);
    }
